...
def get_args():
    ...
    parser.add_argument('--num_slice', type=int, default=8, help='num of slice per iteration')
...
def train(args, generator, registor, discriminator, train_dataloader, val_dataloader, device=None, logger=None):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for i, (ct_data, cta_data) in loop:
            ...
            # mseloss = []
            psnr_list = []
            ct_img = ct_data['img'].permute(3,0,1,2)
            cta_img = cta_data['img'].permute(3,0,1,2)
