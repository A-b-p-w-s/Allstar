from criterions.criterion import compute_edge
from datasets.dataset import collate_fn_nii, CT_CTA_Dataset
...
if __name__ == '__main__':
    ...
    dataset = CT_CTA_Dataset(ct_files, cta_files_A0) #     
    ...
    for ct_data, cta_data in tqdm(dataloader):
        ...
        edg1 = compute_edge(ct_img[100,:,:], kernel='sobel') # 获取单一切片的图像
